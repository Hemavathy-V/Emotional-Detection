...
.stButton > button:hover {
    ...
    box-shadow: 0 10px 36px rgba(255,107,107,0.45) !important;
}
...
def parse_scores(raw) -> dict:
    """pipeline with top_k=None returns [[{label,score},...]] for a single text."""
...
if "last" not in st.session_state:
    st.session_state.last = None   # stores {"emotion", "confidence", "scores"}
